class MakeEphysRecording():
    ...
    def make(table, key, table_map):
        ...
        inserted_probe_serial_number = (table_map['ProbeInsertion'] * table_map['Probe'] & key).fetch1('probe')
        ...
        supported_probe_types = table_map['ProbeType'].fetch('probe_type')
        ...
        if acq_software == 'SpikeGLX':
            ...
            if spikeglx_meta.probe_model in supported_probe_types:
                ...
                electrode_query = table_map['Electrode'] & {'probe_type': probe_type}
